...
func TestShouldSignUpAndVerify(t *testing.T) {
...
func TestShouldLogInResetPwdChangeItLogInAgain(t *testing.T) {
	//Login with bad pwd
...
func TestShouldEditAccount(t *testing.T) {
	//Edit email account
	...
	_, editErr2 := accountClient.Edit(ctx, &account.EditAccountRequest{
		...
		Billing: &account.Billing{
			Contact:       "Axway",
			AddressLine_1: "Tour WGetAccountDetailsRequest",
...
func TestShouldListAndGetAccountDetails(t *testing.T) {
...
func TestShouldRemoveAccount(t *testing.T) {
	//Remove account
